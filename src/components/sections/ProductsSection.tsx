    ...
    <section id="produtos" className="px-6 py-20 md:px-12 md:py-28">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {products.map((product, index) => {
          const contactUrl = `${whatsappUrl}?text=${encodeURIComponent(product.message)}`
            ...
            <Reveal key={product.id} delay={index * 100}>
              <article className="group relative">
                <div className="relative flex aspect-[3/4] items-center justify-center overflow-hidden bg-[var(--cream)]">
                  ...
                  <div className="absolute inset-0 z-20 hidden items-center justify-center bg-[rgba(44,26,14,0.68)] opacity-0 transition duration-500 group-hover:opacity-100 md:flex">
                ...
                <Button asChild variant="whatsapp" className="mt-5 w-full md:hidden">
                  <a href={contactUrl} target="_blank" rel="noreferrer">
                    <MessageCircle size={18} />
